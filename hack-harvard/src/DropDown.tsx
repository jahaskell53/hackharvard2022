...
export default function DropDown({initialSelected, options, changeSel}) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="inline-flex w-full justify-center 0 text-indigo-500">
          {selected}
      ...
      >
        <Menu.Items className="absolute z-10 mt-2 w-56 origin-top-right rounded-md bg-white focus:outline-none ">
          <div className="py-1">
