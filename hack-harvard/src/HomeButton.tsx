...
function EndButton() {
  ...
  return (<>
    <button className={`shadow-md transition-all rounded-lg font-bold py-2 px-4 rounded text-2xl inline-flex flex items-center gap-2 text-black border-2 border-solid border-black hover:bg-black hover:text-white`} onClick={(e) => { e.preventDefault();
    navigate("/");
    }}  >
