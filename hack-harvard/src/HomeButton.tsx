...
function EndButton() {
  ...
  return (<>
    <button className={`shadow-md transition-all rounded-lg font-bold py-2 px-4 rounded text-2xl inline-flex flex items-center gap-2 text-white border-2 border-solid border-white hover:bg-gray-400 hover:text-white bg-black-100`} onClick={(e) => { e.preventDefault();
    navigate("/");
    }}  >
